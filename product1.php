...
<div id="container">
	...
	<div class="nav">
		...
		<div class="nav1">
			<ul>
				<li><a href="product1.php" class="active" style="color:#111;">Shoes</a></li>
				<li>|</li>
				<li><a href="pants1.php">Pants</a></li>
				<li>|</li>
	...
	<div id="content">
		...
		<div id="product">
			...
			<?php 
				...
				$query = $conn->query("SELECT *FROM product WHERE category='shoes' ORDER BY product_id DESC") or die (mysqli_error());
