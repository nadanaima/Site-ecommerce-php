	...
	<div class="nav">
		...
		<div class="nav1">
			<ul>
				...
				<li>|</li>
				<li><a href="football1.php" class="active" style="color:#111;">Pants</a></li>
				<li>|</li>
				<li><a href="running1.php">Tshirts</a></li>
			</ul>
	...
	<div id="content">
		...
		<div id="product">
			...
			<?php 
				...
				$query = $conn->query("SELECT *FROM product WHERE category='pants' ORDER BY product_id DESC") or die (mysqli_error());
