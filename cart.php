	...
	<div class="nav">	
			 <ul>
				...
				<li><a href="privacy1.php"><i class="icon-info-sign"></i>Privacy Policy</a></li>
				 ...
				 <li><a href="upload1.php"><i class="icon-quastion-sign"></i>Upload</a></li>
			</ul>
	</div>
...
if (isset($_SESSION['cart']))
	...
	$total=$total+$line_cost;
		...
		echo "<td><strong><h3>DH ".$line_cost."</h3></strong>";
		echo "</tr>";
		}
		...
		echo "<td><strong><input type='hidden' value='".$total."' required name='total'><h2 class='text-danger'>DH ".$total."</h2></strong></td>";
		echo "<td></td>";
