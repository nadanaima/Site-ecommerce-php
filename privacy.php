	...
	<div class="nav">	
		...
		<div id="content">
			<legend><h3>Privacy Policy</h3></legend>
				<p>The Sport Incorporated respect the privacy of the visitors
			...
			<hr>
				<h4>Protection of visitors information</h4>
					<p>In order to protect the information you provide to us by visiting our website we have implemented various
						...
						risk that third parties may intercept and use that information. While Sport strives to protect its user's 
