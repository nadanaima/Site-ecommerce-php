...
<div id="container">
	<div class="nav">
			 ...
			 <ul>
				...
				<li><a href="upload.php"><i class="icon-inbox"></i>Upload</a></li>
			</ul>
	</div>
	...
	<div class="nav1">
		<ul>
			...
			<li>|</li>
			<li><a href="football.php" >Pants</a></li>
			<li>|</li>
			<li><a href="running.php" class="active" style="color:#111;">Tshirts</a></li>
		</ul>
	</div>
	...
	<div id="content">
		...
		<div id="product">
			...
			<?php 
				...
				$query = $conn->query("SELECT *FROM product WHERE category='Tshirt' ORDER BY product_id DESC") or die (mysqli_error());
