		...
		<div id="carousel">
			<div id="myCarousel" class="carousel slide">
				<div class="carousel-inner">
					...
					<div class="item" style="padding:0; border-bottom:0 solid #111;"><img src="img/nshoes7.jpg" class="carousel"></div>
					<div class="item" style="padding:0; border-bottom:0 solid #111;"><img src="img/banner3.jpg" cl1ass="carousel"></div>
				</div>
