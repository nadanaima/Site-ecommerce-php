...
--
-- Hôte : 127.0.0.1
-- Généré le :  ven. 24 avr. 2020 à 03:49
...
(442, 1, 10000, 'ON HOLD', 'Apr 24, 2020'),
(622, 1, 10000, 'ON HOLD', 'Apr 24, 2020'),
(651, 1, 12000, 'ON HOLD', 'Apr 05, 2020'),
(674, 1, 102000, 'ON HOLD', 'Apr 05, 2020'),
(850, 1, 10000, 'ON HOLD', 'Apr 24, 2020'),
(5476, 1, 10000, 'ON HOLD', 'Apr 24, 2020');
...
CREATE TABLE `user_carts` (
  ...
  `user_cart` varchar(5000) NOT NULL
) ENGINE=MyISAM DEFAULT CHARSET=latin1;
...
--
ALTER TABLE `transaction_detail`
  MODIFY `transacton_detail_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=21;
--
-- AUTO_INCREMENT pour la table `user_carts`
--
ALTER TABLE `user_carts`
  MODIFY `idCart` int(11) NOT NULL AUTO_INCREMENT;COMMIT;
